            ...
            <div ref={printComponentRef} style={{ direction: "rtl" }}>
                <Card>
                    ...
                    <main className='px-2'>
                        ...
                        <div className='px-2'>
                            <div>
                                <h1 className='font-bold text-lg py-8'>تشخیص اولیه پزشک</h1>
                            ...
                            <div>
                                <h1 className='font-bold text-lg py-8'>تشخیص نهایی</h1>
                                <h1 className='text-slate-300'>
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                            ...
                            <div>
                                <h1 className='font-bold text-lg py-8'>نتیجه آزمایشات</h1>
                                <h1 className='text-slate-300'>
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                                    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------------
