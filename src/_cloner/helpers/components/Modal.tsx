    ...
    <div className='fixed inset-0 z-[150]'>
      <div className='flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:p-0'>
        ...
        {reqular ? (
          ...
          <div
            className={`inline-block z-[200] h-[40rem] transform overflow-auto rounded-lg bg-white text-right align-bottom shadow-xl transition-all sm:my-8 sm:w-[80%] sm:align-middle ${className}`}
